...
> Every site ships with a complete, production-grade web presence — not just a homepage.
> Reference implementation: https://install.doctor (study its manifest, meta tags, and PWA setup)
