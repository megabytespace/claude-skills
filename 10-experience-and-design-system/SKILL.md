...
**Underline-sweep (text links default):** `background-image: linear-gradient(currentColor, currentColor); background-size: 0 1.5px; background-position: 0 100%; background-repeat: no-repeat; transition: background-size 0.3s var(--ease-out);` then `:hover { background-size: 100% 1.5px; }`. Brand-color underline grows L→R. NEVER plain `text-decoration: underline` on hover (jarring jump-cut).
